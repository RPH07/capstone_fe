...
const Footer = () => {
return (
<footer className="relative w-full bg-[#242323] px-4 py-12">
    ...
    <div className="w-full lg:w-[500px] mb-8 lg:mb-0">
        ...
        <a href="#" className="text-white hover:text-gray-600"><FontAwesomeIcon icon={faFacebook} size="2x" /></a>
        <a href="#" className="text-white hover:text-gray-600"><FontAwesomeIcon icon={faTwitter} size="2x" /></a>
        <a href="#" className="text-white hover:text-gray-600"><FontAwesomeIcon icon={faInstagram} size="2x" /></a>
        </div>
    </div>
    </div>
